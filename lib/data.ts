...
export const clinica = {
  ...
  whatsappLink:
    "https://wa.me/5491155945109?text=Hola%20CARDIORAN%2C%20quisiera%20solicitar%20un%20turno%20con%20el%20Dr.%20Ramiro%20Nieto.",
  ...
  horarios: [
    { dias: "Lunes a sábado", horas: "11:00 – 13:00" },
    { dias: "Lunes a viernes", horas: "18:00 – 21:30" },
  ] as Horario[],
};

export const doctor = {
  nombre: "Dr. Ramiro Nieto",
  especialidad: "Médico Cardiólogo",
  iniciales: "RN",
  bio: "El Dr. Ramiro Nieto es médico especialista en cardiología. Se dedica a la prevención, el diagnóstico y el tratamiento de las enfermedades del corazón, con una atención cercana y personalizada para cada paciente.",
};
...
export const servicios: Servicio[] = [
  ...
  },
  {
    ...
    descripcion:
      "Monitoreo continuo del ritmo cardíaco durante el día a día para detectar arritmias intermitentes.",
    icono: "⏱️",
  },
  {
    slug: "mapa-presion",
